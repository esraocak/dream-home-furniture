  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography variant="h2">Desing Your Dream Home</Typography>
          <Typography variant="body1" align="justify">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laborum
            cum fuga laudantium? Excepturi reiciendis minus doloribus quas
            reprehenderit pariatur alias dolor veniam sit libero architecto,
            enim atque temporibus ipsam consequuntur!
          </Typography>
          <Button
            onClick={() => navigate("/products")}
            variant="contained"
            sx={{ background: "#d7ccc8", color: "black", width: "10rem" }}
          >
            SHOP NOW
          </Button>
        </Box>
      ...
      >
        ...
        >
          {productList?.slice(0, 3).map((item, index) => {
            return (
              <Card sx={{ maxWidth: 400, m: 3 }} key={index}>
                <CardActionArea>
                  <CardMedia
                    component="img"
                    height="140"
      ...
      <Box sx={{ background: "#eaded7", height: "25rem" }}>
        ...
        >
          ...
          <Typography variant="body1" m="3rem" color="#453227">
            ...
            maiores vel ex? Error alias eius, quod saepe ut exercitationem?
          </Typography>
        </Container>
      ...
      <Box sx={{ p: "3rem", mt: "3rem", height: "1rem" }}>
        ...
        >
          <Typography variant="body1">
            ...
            debitis id! Maxime sunt aliquid earum! Non quidem quos alias
            similique ab reprehenderit, id perspiciatis recusandae animi error
            dolor iure dolorum.
          </Typography>
